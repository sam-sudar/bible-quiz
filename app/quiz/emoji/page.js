  ...
  return (
    <main className="min-h-screen bg-transparent text-white flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-5xl text-center ">
        ...
        {/* Verse */}
        <p className="text-md text-[#f4e9cd] italic animate-fade-up delay-100">
        ...
        >
          ...
          <div className="relative z-10 text-left w-full space-y-4">
            <h2 className="text-4xl font-poppins font-semibold text-yellow-200 mb-6">
              📜 Rules
            </h2>
        ...
        <Link
          ...
          className="inline-block mt-4 px-10 py-4 bg-gradient-to-br from-yellow-400 via-pink-400 to-purple-500 text-[#1b1b3a] font-bold rounded-full 
